...
{ 
	public class Card 
	{
		...
		public Card (int id, int rank, int suit, bool isOpened) 
			: this(id, rank, suit)
		{
			this.isOpened = isOpened;
		}
		private Card (int id, int rank, int suit, bool isOpened, bool isMovedToCommunity, bool isMovedToThron) 
			: this(id, rank, suit)
		{
			this.isOpened = isOpened;
		...
		public Card Copy()
		{
			return new Card (id, rank, suit, isOpened, isMovedToCommunity, isMovedToThron);
		}
